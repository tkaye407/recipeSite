...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: '',
            apiKey: 'Gm99RRqI8t8ExgfP98gQxaCqGOoXUlzP6AOdJI6p',
    ...
    var invokeUrl = 'https://pw5y21pcql.execute-api.us-east-1.amazonaws.com/RecipeApp';
    ...
    apigClient.recipesRecipeIdGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['recipe_id'], ['body']);
    ...
    apigClient.recipesRecipeIdCommentsPost = function (params, body, additionalParams) {
        ...
        var recipesRecipeIdCommentsPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/recipes/{recipe_id}/comments').expand(apiGateway.core.utils.parseParametersToObject(params, ['recipe_id', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
