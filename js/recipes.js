...
function getRecipes() {
    ...
    if (tagParam) {
        ...
        queryParams.searchStr = searchStrParam;
    }

    var apigClient = apigClientFactory.newClient();
    apigClient.recipesGet({}, {}, {queryParams}).then(result => {
        for (recipe of result.data) {
            ...
            newRecipeContainerLink.setAttribute('href', `recipe.html?id=${recipe._id}`);
